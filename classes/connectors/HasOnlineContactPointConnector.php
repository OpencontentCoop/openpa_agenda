...
class HasOnlineContactPointConnector extends AbstractBaseConnector
{
    ...
    {
        $this->context = eZContentObject::fetchByRemoteID(self::generateRemoteId((int)$this->getHelper()->getParameter('context')));
    ...
    protected function submit()
    {
        ...
        if ($privateOrganization instanceof eZContentObject || eZHTTPTool::instance()->hasSessionVariable("RegisterAgendaAssociazioneID")) {
