...
class OpenPAAgendaSolrDocumentFieldeZTags extends ezfSolrDocumentFieldBase
{
    /**
    ...
    public function getData()
    {
        ...
        $indexParentTagsPerClassAttributeIdentifiers = eZINI::instance('eztags.ini')->variable('SearchSettings', 'IndexParentTagsPerClassAttribute');
        $classAttributeIdentifier = $this->ContentObjectAttribute->attribute('object')->attribute('class_identifier') . '/' . $contentClassAttribute->attribute('identifier');
        if(in_array($classAttributeIdentifier, $indexParentTagsPerClassAttributeIdentifiers)){
            $indexParentTags = true;
        }
