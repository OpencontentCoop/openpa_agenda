...
{if or(is_set($social_links.facebook), is_set($social_links.twitter), is_set($social_links.linkedin), is_set($social_links.instagram), is_set($social_links.youtube), is_set($social_links.whatsapp), is_set($social_links.telegram), is_set($social_links.tiktok))}
<div class="it-socials d-none d-md-flex">
    ...
    <ul>
        ...
        {if is_set($social_links.whatsapp)}
            <li>
                <a href="{$social_links.whatsapp}" aria-label="WhatsApp" target="_blank">
        ...
        {if is_set($social_links.telegram)}
            <li>
                <a href="{$social_links.telegram}" aria-label="Telegram" target="_blank">
        ...
        {if is_set($social_links.tiktok)}
            <li>
                <a href="{$social_links.tiktok}" aria-label="TikTok" target="_blank">
