...
{if and($post.images, $post.images.has_content)}
  ...
  <div class="row">
    <div class="col-sm-12" style="margin-bottom: 10px;">
      <div class="well well-sm clearfix">
        ...
        <a class="gallery-strip-thumbnail" href={$main_image|attribute('image').content['imagefull'].url|ezroot} title="{$main_image.name|wash()}" data-gallery>
  ...
  <div class="row">
    ...
    <div class="col-sm-{$col-width}" style="margin-bottom: 10px;">
      <div class="row">
      <div class="col-xs-6">
        <a class="gallery-strip-thumbnail" href={$item|attribute('image').content['imagefull'].url|ezroot} title="{$item.name|wash()}" data-gallery>
