...
{set-block scope=root variable=subject}[{$social_pagedata.logo_title|strip_tags()}] {'L\'evento %name è stato rifiutato'|i18n('agenda/mail', '', hash('%name', $post.object.name|wash()))}{/set-block}
