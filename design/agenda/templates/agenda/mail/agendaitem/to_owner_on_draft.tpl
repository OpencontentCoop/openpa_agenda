...
{set-block scope=root variable=subject}[{$social_pagedata.logo_title|strip_tags()}] {'Evento %name in lavorazione'|i18n('agenda/mail', '', hash('%name', $post.object.name))}{/set-block}
