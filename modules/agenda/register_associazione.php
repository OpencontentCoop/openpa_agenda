...
if (OpenPAAgenda::instance()->isAutoRegistrationEnabled()) {
    if ($Action == 'activate') {
        ...
        $contentInfoArray = array('url_alias' => 'agenda/register_associazione');
        ...
        if ($http->hasSessionVariable("RegisterAgendaAssociazioneID")) {
            ...
            if ($node instanceof eZContentObjectTreeNode && $class->attribute('id')) {
                ...
                if ($object) {
                    $http->setSessionVariable('RedirectURIAfterPublish', '/agenda/register_associazione/activate');
        ...
        if (!function_exists('checkContentActions')) {
            ...
            )
            {
                ...
                if ($Module->isCurrentAction('Publish')) {
                    ...
                    $http->removeSessionVariable("RegisterAgendaAssociazioneID");
                    $http->removeSessionVariable('StartedRegistrationAgendaAssociazione');
                    $Module->redirectTo('agenda/register_associazione/activate');
